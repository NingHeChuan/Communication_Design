...
#
# Generated by export_simulation on Tue Jan 08 10:13:52 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_square.sh' script.

./blk_mem_square.sh -reset_run
...
./blk_mem_square.sh -noclean_files

For more information on the script, please type './blk_mem_square.sh -help'.
